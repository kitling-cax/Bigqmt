...
BIGQMT_REDIS_CONFIG = {
    ...
    # A broker-capable order gateway is deployed with BIGQMT_BRIDGE, but it is
    # separately fail-closed.  Do not change this block until P06 has all
    # evidence, a named strategy sleeve, and a user-approved simulation test.
    # Opening rpc_allow_order_methods alone still cannot submit or cancel.
    "execution_admission": {
        ...
        # Production has its own local config/deployment directory.  These
        # stay false here and must never be copied from a simulation machine.
